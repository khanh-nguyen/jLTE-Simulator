...
public class RandomSector extends AbstractSector {
    ...
    public static RandomSector fromXML(Configuration config, Node xml, ENodeB eNodeB, Location location) {
        ...
        return new RandomSector(config, params.getSectorId(), eNodeB, location, params.getTxPower(),
                params.getAzimuth(), params.getHeight(), params.getDowntilt(), params.getAntennaGain());
    }

    public RandomSector(Configuration config, int sectorId, final ENodeB eNodeB, final Location loc,
